...
def train_dino(args):
    ...
    dataset = RegionDataset(dataset_dir=args.dataset_dir, transform=transform, database=database)
...
def train_one_epoch(student, teacher, teacher_without_ddp, dino_loss, data_loader,
    ...
    for it, (images, _) in enumerate(metric_logger.log_every(data_loader, 10, header)):
        ...
        with torch.cuda.amp.autocast(fp16_scaler is not None):
            ...
            _, student_output = student(images)
...
class RegionDataset(Dataset):
    def __init__(self, dataset_dir, transform, database):
    ...
    def __getitem__(self, index):
        bytes_data =  self.database.get(index)
        ...
        return self.transform(tensor_data), label
...
# python -m torch.distributed.launch --nproc_per_node=8 Hierarchical-Pretraining/main_dino4k.py --output_dir /remote-home/share/Carboxy/Exps/HIPT_4k_DINO --epochs 100

# CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 Hierarchical-Pretraining/main_dino4k.py --output_dir /remote-home/share/Carboxy/Exps/WSISSL/HIPT_4k/DINO_4gpu --epochs 100 --batch_size_per_gpu 128
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 Hierarchical-Pretraining/main_dino4k.py --output_dir /remote-home/share/Carboxy/Exps/WSISSL/HIPT_4k/DINO_8gpu_64 --epochs 100 --batch_size_per_gpu 64
